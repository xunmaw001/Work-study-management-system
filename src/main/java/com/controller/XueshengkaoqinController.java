...
public class XueshengkaoqinController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,XueshengkaoqinEntity xueshengkaoqin, HttpServletRequest request){
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,XueshengkaoqinEntity xueshengkaoqin, HttpServletRequest request){
        EntityWrapper<XueshengkaoqinEntity> ew = new EntityWrapper<XueshengkaoqinEntity>();
		PageUtils page = xueshengkaoqinService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, xueshengkaoqin), params), params));
        return R.ok().put("data", page);
    }
