...
public class GangweishenqingController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,GangweishenqingEntity gangweishenqing, HttpServletRequest request){

		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("laoshi")) {
			gangweishenqing.setLaoshizhanghao((String)request.getSession().getAttribute("username"));
		}
