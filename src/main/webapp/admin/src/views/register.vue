  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:10px">
        <h1 class="h1" style="color:rgba(30, 136, 229, 1);fontSize:28px;">勤工助学管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="老师姓名" class="input" v-if="tableName=='laoshi'">
			  <el-input v-model="ruleForm.laoshixingming" autocomplete="off" placeholder="老师姓名" type="text" />
																					...
																					<!-- <div v-if="tableName=='laoshi'" class="input-group">
			   <div class="label">学院部门</div>
			   <div class="input-container">
			     <input v-model="ruleForm.xueyuanbumen" class="input" type="text" placeholder="学院部门">
			   </div>
			 </div> -->
			<el-form-item label="学院部门" class="input" v-if="tableName=='laoshi'">
			  <el-input v-model="ruleForm.xueyuanbumen" autocomplete="off" placeholder="学院部门" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='laoshi'" class="input-group">
