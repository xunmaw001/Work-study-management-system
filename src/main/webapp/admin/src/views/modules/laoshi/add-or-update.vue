        ...
        <div v-else>
	      ...
	      <el-input v-model="ruleForm.xingbie"
                placeholder="性别" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="学院部门" prop="xueyuanbumen">
          <el-input v-model="ruleForm.xueyuanbumen" 
              placeholder="学院部门" clearable  :readonly="ro.xueyuanbumen"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="学院部门" prop="xueyuanbumen">
              <el-input v-model="ruleForm.xueyuanbumen" 
                placeholder="学院部门" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xingbie = true;
            continue;
	            	            ...
	            	            if(o=='xueyuanbumen'){
            this.ruleForm.xueyuanbumen = obj[o];
	    this.ro.xueyuanbumen = true;
            continue;
          }
	            	            if(o=='laoshishouji'){
